...
namespace Unclassified.TxLib
{
	...
	public struct DateTimeInterval
	{
		...
		{
			if (months < 0) throw new ArgumentOutOfRangeException(nameof(months), "Interval components cannot be negative.");
			if (days < 0) throw new ArgumentOutOfRangeException(nameof(days), "Interval components cannot be negative.");
			this.start = end = start;
			if (years < 0)
			{
				negative = true;
		...
		public DateTimeInterval(DateTime start, int years, int months, int days, int hours, int minutes, int seconds)
		{
			if (months < 0) throw new ArgumentOutOfRangeException(nameof(months), "Interval components cannot be negative.");
			if (days < 0) throw new ArgumentOutOfRangeException(nameof(days), "Interval components cannot be negative.");
			if (hours < 0) throw new ArgumentOutOfRangeException(nameof(hours), "Interval components cannot be negative.");
			if (minutes < 0) throw new ArgumentOutOfRangeException(nameof(minutes), "Interval components cannot be negative.");
			if (seconds < 0) throw new ArgumentOutOfRangeException(nameof(seconds), "Interval components cannot be negative.");
			this.start = end = start;
			if (years < 0)
			{
				negative = true;
		...
		public DateTimeInterval(DateTime start, int years, int months, int days, int hours, int minutes, int seconds, int milliseconds)
		{
			...
			if (minutes < 0) throw new ArgumentOutOfRangeException(nameof(minutes), "Interval components cannot be negative.");
			if (seconds < 0) throw new ArgumentOutOfRangeException(nameof(seconds), "Interval components cannot be negative.");
			if (milliseconds < 0) throw new ArgumentOutOfRangeException(nameof(milliseconds), "Interval components cannot be negative.");
			this.start = end = start;
			if (years < 0)
			{
				negative = true;
